'''
simple code using keras to train DQN on given openAI env
'''
import argparse
...
'''
Below code is to train on GPU, requires nvidia GPU , tensorflow-gpu keras-gpu, cuda, cuDNN
'''
...
class DQN():
    ...
    def __init__(self, env, no_states, no_action, memory_size=100000, model_layers=[16, 32, 16],
